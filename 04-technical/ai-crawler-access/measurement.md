...
- **Dated re-check (2026-09-23).** `anthropic-ai` remains absent from Anthropic's crawler article, now served at support.claude.com and naming three tokens (`ClaudeBot`, `Claude-User`, `Claude-SearchBot`) — https://support.claude.com/en/articles/8896518. The 2026-09-04 line above stands as written.
- **Dated note (2026-09-23) — llms.txt discovery has been measured elsewhere; use has not.** A server-log study (Hall, published 2026-09-17, https://doi.org/10.5281/zenodo.22814844) counts crawler requests for an announced llms.txt (1,549 over 165 site-days) against an un-announced root file (2 requests); it measures fetches, not recognition, parsing or use, and its author declares a competing interest. Bytes exposed, the proxy here, sits one step before even that.
- **Dated note (2026-09-23) — declared versus enforced access.** This recipe measures what robots.txt declares. Whether a network layer in front of the site enforces, overrides or prices that declaration is a different measurement, not made here.
